...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        ...
        },
        {
          name: "Jane Smith",
          handle: "@janes",
          testimonial: "Found our perfect home in days!",
          rating: 5,
        ...
        },
        {
          name: "Mike Ross",
          handle: "@miker",
          testimonial: "Seamless process, highly recommended.",
          rating: 5,
        ...
        },
        {
          name: "Sara Lee",
          handle: "@saral",
          testimonial: "They truly care about your needs.",
          rating: 5,
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/close-up-natural-beauty-woman-portrait-soft-make-up-red-lips-summer-warm-colours-freshness-happiness_291049-2751.jpg",
          alt: "Client 1",
        },
        {
          src: "http://img.b2bpic.net/free-photo/close-up-young-pregnant-woman_23-2149144862.jpg",
          alt: "Client 2",
        },
        {
  ...
  <div id="about" data-section="about">
      ...
      heading={[
        {
          type: "text",
          content: "Experience Excellence in ",
        },
        {
          type: "image",
          src: "http://img.b2bpic.net/free-photo/productive-working-meeting_1098-15085.jpg",
          alt: "About Baolas Homes",
        },
        {
          type: "text",
          content: " Real Estate",
      ...
      features={[
        {
          ...
          description: "Guaranteed security throughout the buying process.",
        },
        {
          icon: Zap,
          title: "Fast Processing",
          description: "We accelerate your real estate journey.",
        },
        {
          icon: Award,
          title: "Expert Guidance",
          description: "Decades of industry experience at your service.",
        },
      ]}
      ...
      products={[
        {
          ...
          rating: 5,
          reviewCount: "12",
          imageSrc: "http://img.b2bpic.net/free-photo/modern-luxury-villa-with-swimming-pool-blue-sky_23-2151974381.jpg",
        },
        {
          id: "2",
          brand: "Modern",
        ...
        },
        {
          ...
          rating: 5,
          reviewCount: "22",
          imageSrc: "http://img.b2bpic.net/free-photo/beautiful-red-brick-house-with-decorative-lights_53876-49372.jpg",
        },
      ]}
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        ...
        },
        {
          ...
          description: "In local real estate.",
          icon: Calendar,
        },
        {
          id: "m3",
      ...
      team={[
        {
          ...
          name: "Alex Riv",
          role: "Senior Broker",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-male-real-estate-agent_23-2150164688.jpg",
        },
        {
          id: "t2",
          name: "Sarah Lee",
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          name: "Charlie Day",
          handle: "@charlied",
          testimonial: "Smooth closing process.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Dana White",
          handle: "@danaw",
          testimonial: "They listen to what you need.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Evan Lord",
          handle: "@evanl",
          testimonial: "Experts at negotiating deals.",
          rating: 5,
      ...
      faqs={[
        {
          ...
          content: "Typically 30-45 days.",
        },
        {
          id: "f2",
          title: "Do you handle valuation?",
          content: "Yes, free valuation included.",
        },
        {
          id: "f3",
          title: "Can you help with investment?",
          content: "Yes, we specialize in high yield.",
        },
      ]}
